...
namespace proyecto_ped
{
    class vertice
    {
        ...
        public List<arco> ListaAdyacencia; // Lista de adyacencia del nodo
        ...
        public vertice Padre;//nodo que sirve en los recorridos como el antecesor 
        ...
        public void DibujarVertice(Graphics g)
        {
            ...
            g.DrawString(this.Valor, new Font("Century Gothic", 14, FontStyle.Bold), new SolidBrush(color_fuente),
        ...
        {
            SolidBrush b = new SolidBrush(Color.SpringGreen);
            // Definimos donde dibujaremos el nodo
            Rectangle areaNodo = new Rectangle(this._posicion.X - radio, this._posicion.Y - radio,
            this.dimensiones.Width, this.dimensiones.Height);
            g.FillEllipse(b, areaNodo);
            g.DrawString(this.Valor, new Font("Century Gothic", 14, FontStyle.Bold), new SolidBrush(Color.White),
            this._posicion.X, this._posicion.Y,
            new StringFormat()
            {
                Alignment = StringAlignment.Center,
            ...
            g.DrawEllipse(new Pen(Brushes.SpringGreen, (float)1.0), areaNodo);
            b.Dispose();
        }
    }
}
